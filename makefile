...
all:
	mkdir -p bin
	$(CC) $(CFLAGS) $(INCLUDES) $(LDFLAGS) ogl_utils.c egl_utils.c dividers_gl.c lodepng.c background_gl.c font_gl.c particles_gl.c mover_gl.c renderer.c geometry.c hash.c communication.c fluid.c -o bin/sph.out
debug:
	mkdir -p bin
