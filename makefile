...
all:
	mkdir -p bin
	cd src && g++ $(CINCLUDES) $(CPPFLAGS) particles_gl.cpp -c
	cd src && $(CC) $(CINCLUDES) $(CFLAGS) $(CLIBS) ogl_utils.c dividers_gl.c particles_gl.o liquid_gl.c mover_gl.c font_gl.c lodepng.c renderer.c glfw_utils.c image_gl.c cursor_gl.c background_gl.c controls.c setup.c hash_sort.cpp communication.c fluid.c -o ../bin/sph.out
clean:
	rm -f ./sph.out
	rm -f ./*.o
